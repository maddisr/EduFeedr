<?php
    ...
    $title = elgg_view_title(elgg_echo('edufeedr:title:ongoing:courses'));

    $content = "";

	$offset = get_input('offset', 0);
	$entities_count = elgg_get_entities_from_metadata(array('type' => 'object', 'subtype' => 'educourse', 'metadata_name_value_pairs' => array(
		array('name' => 'signup_deadline', 'value' => time(), 'operand' => '<', 'case_sensitive' => 'false'),
		array('name' => 'course_starting_date', 'value' => time(), 'operand' => '<', 'case_sensitive' => 'false'),
		array('name' => 'course_ending_date', 'value' => time(), 'operand' => '>', 'case_sensitive' => 'false')
	), 'count' => 'true'));
